...
#input_birthrate_data <- read.csv(here("data-raw", countryname, "birthrate.csv"),
#                                 stringsAsFactors = FALSE)  # already divided this by 1000

#input_migration_data <- read.csv(here("data-raw", countryname, "migration_rates.csv"),
#                                 stringsAsFactors = FALSE)

# Age- and sex-specific datasets
input_popsize_female_1950to2015 <- read.csv(here("data-raw",
                                                 countryname,
                                                 "WPP2017_POP_F15_3_ANNUAL_POPULATION_BY_AGE_FEMALE_1950_2015.csv"),
                                            header = TRUE, check.names = FALSE,
                                            stringsAsFactors = FALSE)
input_popsize_female_2015to2100 <- read.csv(here("data-raw",
                                                 countryname,
                                                 "WPP2017_POP_F15_3_ANNUAL_POPULATION_BY_AGE_FEMALE_MEDIUM_2015_2100.csv"),
                                            header = TRUE, check.names = FALSE,
                                            stringsAsFactors = FALSE)

input_popsize_male_1950to2015 <- read.csv(here("data-raw",
                                               countryname,
                                               "WPP2017_POP_F15_2_ANNUAL_POPULATION_BY_AGE_MALE_1950_2015.csv"),
                                          header = TRUE, check.names = FALSE,
                                          stringsAsFactors = FALSE)
input_popsize_male_2015to2100 <- read.csv(here("data-raw",
                                               countryname,
...
input_lifetables_male_1950to2015 <- read.csv(here("data-raw",
                                                  countryname,
                                                  "WPP2017_MORT_F17_2_ABRIDGED_LIFE_TABLE_MALE_1950_2015.csv"),
                                             header = TRUE, check.names = FALSE,
                                             stringsAsFactors = FALSE)
input_lifetables_male_2015to2050 <- read.csv(here("data-raw",
                                                  countryname,
                                                  "WPP2017_MORT_F17_2_ABRIDGED_LIFE_TABLE_MALE_MEDIUM_2015_2050.csv"),
                                             header = TRUE, check.names = FALSE,
                                             stringsAsFactors = FALSE)
input_lifetables_male_2050to2100 <- read.csv(here("data-raw",
                                                  countryname,
                                                  "WPP2017_MORT_F17_2_ABRIDGED_LIFE_TABLE_MALE_MEDIUM_2050_2100.csv"),
                                             header = TRUE, check.names = FALSE,
                                             stringsAsFactors = FALSE)

input_lifetables_female_1950to2015 <- read.csv(here("data-raw",
                                                    countryname,
                                                    "WPP2017_MORT_F17_3_ABRIDGED_LIFE_TABLE_FEMALE_1950_2015.csv"),
                                               header = TRUE, check.names = FALSE,
                                               stringsAsFactors = FALSE)
input_lifetables_female_2015to2050 <- read.csv(here("data-raw",
                                                    countryname,
                                                    "WPP2017_MORT_F17_3_ABRIDGED_LIFE_TABLE_FEMALE_MEDIUM_2015_2050.csv"),
                                               header = TRUE, check.names = FALSE,
                                               stringsAsFactors = FALSE)
input_lifetables_female_2050to2100 <- read.csv(here("data-raw",
                                                    countryname,
...
input_fertility_1950to2015 <- read.csv(here("data-raw",
                                            countryname,
                                            "WPP2017_FERT_F07_AGE_SPECIFIC_FERTILITY_1950_2015.csv"),
                                       header = TRUE, check.names = FALSE,
                                       stringsAsFactors = FALSE)
input_fertility_2015to2100 <- read.csv(here("data-raw",
                                            countryname,
...
# For validation
# Deaths by age
input_deaths_female_1950to2015 <- read.csv(here("data-raw",
                                                countryname,
                                                "WPP2017_MORT_F04_3_DEATHS_BY_AGE_FEMALE_1950_2015.csv"),
                                           header = TRUE, check.names = FALSE,
                                           stringsAsFactors = FALSE)
input_deaths_female_2015to2100 <- read.csv(here("data-raw",
                                                countryname,
                                                "WPP2017_MORT_F04_3_DEATHS_BY_AGE_FEMALE_MEDIUM_2015_2100.csv"),
                                           header = TRUE, check.names = FALSE,
                                           stringsAsFactors = FALSE)

input_deaths_male_1950to2015 <- read.csv(here("data-raw",
                                              countryname,
                                              "WPP2017_MORT_F04_2_DEATHS_BY_AGE_MALE_1950_2015.csv"),
                                         header = TRUE, check.names = FALSE,
                                         stringsAsFactors = FALSE)
input_deaths_male_2015to2100 <- read.csv(here("data-raw",
                                              countryname,
...
# Total births
input_births_1950to2015 <- read.csv(here("data-raw",
                                         countryname,
                                         "WPP2017_FERT_F01_BIRTHS_BOTH_SEXES_1950_2015.csv"),
                                    header = TRUE, check.names = FALSE,
                                    stringsAsFactors = FALSE)
input_births_2015to2100 <- read.csv(here("data-raw",
                                         countryname,
