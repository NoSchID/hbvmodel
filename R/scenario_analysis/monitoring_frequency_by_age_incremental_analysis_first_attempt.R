...
# This is the old version without DALYS as outcome, IT is not treated and A1
# age group is 15-65.
...
# 1) Incremental benefits and interactions between a set of strategies (monitoring by age) ----
