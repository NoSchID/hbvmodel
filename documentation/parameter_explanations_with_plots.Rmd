...
library(here)
library(knitr)
read_chunk(here("R","imperial_model_calibration.R"))
```
...
** HBsAg loss (Inactive carrier to Immune compartment):**  

Rate = sag_loss_intercept + sag_loss_slope * ages  

**Progression from Immune reactive to Compensated cirrhosis:**

In women and men aged < pr_ir_cc_age_threshold: rate = 0  
In women aged > pr_ir_cc_age_threshold: rate = pr_ir_cc_female
In men aged > pr_ir_cc_age_threshold: rate = cirrhosis_male_cofactor * pr_ir_cc_female

**Progression from HBeAg-negative chronic hepatitis B to Compensated cirrhosis:**

In women: rate = pr_enchb_cc_female
In men: rate = cirrhosis_male_cofactor * pr_enchb_cc_female

Annual sex-specific rates cannot exceed 5.

**Progressions to HCC:**

In women and men aged < cancer_age_threshold: rate = 0  
In women aged > cancer_age_threshold: rate = Multiplier * cancer_prog_constant_female * (cancer_prog_coefficient_female * (ages - cancer_age_threshold))^2  
In men aged > cancer_age_threshold: rate = cancer_male_cofactor * age-specific rate in women  

Annual age- and sex-specific rates cannot exceed 1. 
...
for (i in 1:length(out_mat)) {
  ...
  plot_cancer_function_female <- (out_mat[[i]]$parameter_set$cancer_prog_constant_female + (out_mat[[i]]$parameter_set$cancer_prog_coefficient_female *
  ...
  plot_pr_hccr_it <- ggplot() +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_it*plot_cancer_function_female,
                  colour = "Female")) +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_it*out_mat[[i]]$parameter_set$cancer_male_cofactor*plot_cancer_function_female,
                  colour = "Male"))+
  ...
  plot_pr_hccr_ir <- ggplot() +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_ir*plot_cancer_function_female,
                  colour = "Female")) +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_ir*out_mat[[i]]$parameter_set$cancer_male_cofactor*plot_cancer_function_female,
                  colour = "Male"))+
    labs(title = "Immune reactive (HBeAg+)\nto HCC",
         x = "", y = "", colour = "Sex") +
    theme_bw() +
  ...
  plot_pr_hccr_ic <- ggplot() +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_ic*plot_cancer_function_female,
                  colour = "Female")) +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_ic*out_mat[[i]]$parameter_set$cancer_male_cofactor*plot_cancer_function_female,
                  colour = "Male"))+
  ...
  plot_pr_hccr_enchb <- ggplot() +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_enchb*plot_cancer_function_female,
                  colour = "Female")) +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_enchb*out_mat[[i]]$parameter_set$cancer_male_cofactor*plot_cancer_function_female,
                  colour = "Male"))+
  ...
  plot_pr_hccr_cc <- ggplot() +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_cc*plot_cancer_function_female,
                  colour = "Female")) +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$hccr_cc*out_mat[[i]]$parameter_set$cancer_male_cofactor*plot_cancer_function_female,
                  colour = "Male"))+
  ...
  plot_ir_cc_function_female <- c(rep(0, times = which(ages == out_mat[[i]]$parameter_set$pr_ir_cc_age_threshold-da)),
                                  rep(out_mat[[i]]$parameter_set$pr_ir_cc_female, times = n_agecat - which(ages == out_mat[[i]]$parameter_set$pr_ir_cc_age_threshold-da)))
  
  plot_pr_ir_cc <- ggplot() +
    geom_line(aes(x = ages, y = plot_ir_cc_function_female, colour = "Female")) +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$cirrhosis_male_cofactor * plot_ir_cc_function_female, colour = "Male")) +
  ...
  plot_cirrhosis_prog_function_female <- out_mat[[i]]$parameter_set$pr_enchb_cc_female
  
  plot_pr_enchb_cc <- ggplot() +
    geom_line(aes(x = ages, y = plot_cirrhosis_prog_function_female,
                  colour = "Female")) +
    geom_line(aes(x = ages, y = out_mat[[i]]$parameter_set$cirrhosis_male_cofactor*plot_cirrhosis_prog_function_female,
                  colour = "Male"))+
...
```{r, echo = FALSE,  fig.show="hide", warning = FALSE, fig.height = 8.27, fig.width=11.69}
plot_list = list()
for (i in 1:length(out_mat)) {
